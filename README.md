...
* **2020 Installation Spike**: The number of yearly sensor installations surged dramatically in 2020, rising from 17 in 2019 to 102 in 2020 (600%). This spike coincided with significant events "Orange Skies Day" during wildfire season and the COVID-19 pandemic and the wildfire season. These event, in concert with those of higher educational attainment having access to PurpleAir product informationd and more likely to consume online journalism and articles discussing the product explains the sharp increase this year. The sharp increase in sensors was not sustained in subsequent years, with installation rates dropping significantly in 2021 and 2022.
...
September 9, 2020 was officially been dubbed "[Orange Skies Day](https://en.wikipedia.org/wiki/Orange_Skies_Day)," an entire day when the sun was unable to be seen due to the smoke from 20 simultaneous wildfires. In addition to the awareness that this extreme climate event may have directly provoked, [an article in Wired Magazine](https://www.wired.com/story/bay-area-just-turned-orange-all-eyes-on-purpleair/) articulated how people whom were already sensor owners or consumers of PurpleAir data traversed their website to get a sense of the scale of the event. With the direct impacts of this climate event, coupled with the resultant national press exposure, as well as the COVID-19 pandemic raising generalized health awareness and air quality concerns, culminated in consumers entering a sales funnel to acquire these sensors in numbers unseen in previous years.  

Consulting [Google Trends](https://trends.google.com/trends?geo=US&hl=en-US), we observed a distinct rise in search queries for "PurpleAir Sensor" in August 2020 through September 2020, reaching over 100 queries in a very short time period:
